...
create table if not exists off.products (
  ...
  quantity              text,
  serving_size          text,
  serving_quantity_g    numeric(10, 3),
  -- Per 100 g, from `nutriments`. NULL when OFF has no value.
  energy_kcal_100g      numeric(10, 3),
  energy_kj_100g        numeric(10, 3),
  protein_g_100g        numeric(10, 3),
  carbs_g_100g          numeric(10, 3),
  sugars_g_100g         numeric(10, 3),
  fat_g_100g            numeric(10, 3),
  saturated_fat_g_100g  numeric(10, 3),
  fibre_g_100g          numeric(10, 3),
  salt_g_100g           numeric(10, 3),
