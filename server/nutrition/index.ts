...
export type { NutritionStore, OffProductRow, OffPer100g, CiqualFoodRow, CiqualSimilarRow, SportlyFoodRow, SportlyFoodInput, FoodSynonymRow, FoodSynonymTarget } from './store.js'
export { SIMILARITY_HIGH, SIMILARITY_LOW, SIMILARITY_CANDIDATES, DEFAULT_SIMILARITY, similarityBand, type SimilarityThresholds, type SimilarityBand } from './matching.js'
